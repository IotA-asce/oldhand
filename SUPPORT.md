...
| Need | Best route |
| --- | --- |
| Usage question or workflow advice | Read the [README](README.md) and linked guides; then use GitHub Discussions when enabled. |
| Reproducible defect | Use the bug-report issue template. |
| Product idea or integration request | Use the feature-request issue template. |
...
Support is provided on a best-effort basis. Commercial support is not currently
offered.
