...
Rewrite the repository README as a truthful, visual, end-to-end introduction to Lore: what it remembers, how it works, what has been measured, and where its limits are.
...
2. Add a source-controlled discovery-replay diagram that explains the experience loop introduced in Lore 0.5.0.
...
- The first screen explains Lore in plain language and includes a meaningful visual.
