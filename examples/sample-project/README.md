...
This is a fictional, self-contained project for demonstrating Lore. Every
...
it never merges them. Run the repository-level demonstration from the Lore
checkout:
...
staging value, then retrieves the reviewed Lore constraint that explains why
